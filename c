...
#include <Arduino.h>
#ifndef LED_BUILTIN
#define LED_BUILTIN 2   // geralmente o LED onboard está no pino 2 no ESP32
#endif
...
// Definições manuais dos pinos
#define IR_RECEIVE_PIN 15   // Altere para o pino onde o sensor IR está conectado
#define IR_SEND_PIN 14      // Altere para o pino usado pelo emissor IR (se estiver usando)           
